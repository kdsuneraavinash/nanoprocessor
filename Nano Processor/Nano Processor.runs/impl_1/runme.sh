...
HD_PWD='E:/Projects/Vivaldo/nanoprocessor/Nano Processor/Nano Processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log High_Level_Nano_Processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source High_Level_Nano_Processor.tcl -notrace
